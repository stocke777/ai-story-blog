...
const Editor = ({ handleClick }) => {
	...
	return (
		<div className={`flex-col ${flexCenter}`}>
			...
			<button className="text-blue-700 font-bold rounded-md bg-blue-100 hover:bg-white hover:text-black ease-in-out duration-300 py-2 px-4 m-4 text-2xl" onClick={() => handleClick(title, content, summary)}>
				Submit
			</button>
		</div>
	);
